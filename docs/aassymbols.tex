...
\begin{table}
\caption{Journal Commands}
\begin{center}
\begin{tabular}{lc@{\hspace{2em}}lc}
\aj & \verb"\aj" & \araa & \verb"\araa" \\
\apj & \verb"\apj" & \apjl & \verb"\apjl" \\
\apjs & \verb"\apjs" & \ao & \verb"\ao" \\
\apss & \verb"\apss" & \aap & \verb"\aap" \\
\aapr & \verb"\aapr" \\
\aaps & \verb"\aaps" &
\azh & \verb"\azh" \\
\baas & \verb"\baas" &
...
\qjras & \verb"\qjras" \\
\skytel & \verb"\skytel" &
\solphys & \verb"\solphys" \\
\sovast & \verb"\sovast" &
\ssr & \verb"\ssr" \\
\zap & \verb"\zap" &
\nat & \verb"\nat" \\
\iaucirc & \verb"\iaucirc" &
\aplett & \verb"\aplett" \\
\apspr & \verb"\apspr" &
\bain & \verb"\bain" \\
\fcp & \verb"\fcp" &
...
\memsai & \verb"\memsai" &
\nphysa & \verb"\nphysa" \\
\physrep & \verb"\physrep" &
\physscr & \verb"\physscr" \\
\planss & \verb"\planss" &
\procspie & \verb"\procspie" \\
\actaa & \verb"\actaa" &
\caa & \verb"\caa" \\
\cjaa & \verb"\cjaa" &
\jcap & \verb"\jcap" \\
